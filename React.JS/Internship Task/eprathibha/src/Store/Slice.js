...
export const userSlice = createSlice({
    ...
    reducers: {
        addLoginData(state=taskData,action){
               console.log(action.payload)
               state.data = action.payload

        },
        addExamList(state=taskData,action){
            state.exams = action.payload
            console.log(state.exams)
        },
        addQuestionsList(state=taskData,action){
...
export const { addLoginData, addExamList, addaddQuestionsList} = userSlice.actions;
