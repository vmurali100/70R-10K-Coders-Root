...
export const EditStudent = () => {
 ...
 const { albumId, id, title} = students
  return (
    <div className='container'>
        <form>
            <label htmlFor="">AlbumID</label>
            <input type="text" name="albumId" value={albumId} onChange={(e) => {handleChange(e)}} /> <br />
            ...
            <input type="text" name="url" value={students.url} onChange={(e) => {handleChange(e)}} /> <br />
