...
export class TriveniClass2 extends Component {
    constructor() {
        super()
        this.state = {
            fname: "Triveni",
    ...
    changePerson=()=>{
        this.setState({person:{fname:"Dhruva",lname:"Raam",tel:"8989899998",address:"vijayawada",city:"guntur",state:"Ap",zip:209999}

        })
    }
    displayUsers=()=>{
        this.setState({users :  ['Ram', 'sundar', 'Dhar', 'Dhruv']})
    }
    handleDelete=(i)=>{
        console.log(i)
