...
function getUserIndex() {
    ...
    //     // in users.html when we click on particular edit button the below function is used to display all particular details
    //     for(a in response){
    ...
    // another way to get a data from our local storage withot an api_url
