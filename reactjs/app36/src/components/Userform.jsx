  ...
  return (
    ...
    <form>
        ...
        <div className="mb-3">
            ...
            <input type="text" className="form-control" name='email' value={win.email} onChange={(e)=>{handlechangeevent(e)}}/>
        </div>

        <div className="mb-3">
            <label htmlFor="exampleInputPassword1" className="form-label">password</label>
            <input type="password" className="form-control" name='password' value={win.password} onChange={(e)=>{handlechangeevent(e)}}/>
        </div>
