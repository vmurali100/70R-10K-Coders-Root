...
export const getAllUsers = createAsyncThunk("users/getAllUsers", () => {
  return fetch("http://localhost:4010/nestedusers")
    .then((res) => res.json())
...
export const updateUserAction=createAsyncThunk('users/updateUser',(user,{dispatch})=>{
    return fetch("http://localhost:4010/nestedusers/"+user.id,{
...
return fetch("http://localhost:4010/nestedusers/"+user.id,{method:"DELETE"}).then((res)=>{
