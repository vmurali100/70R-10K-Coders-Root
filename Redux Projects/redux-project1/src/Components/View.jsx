  ...
  return (
    <div className="container py-4">
      ...
      <ul className="list-group w-100">
        ...
        <li className="list-group-item">Street:{user.address.email}</li>
        <li className="list-group-item">Suite:{user.address.suite}</li>
        <li className="list-group-item">City:{user.address.city}</li>
        <li className="list-group-item">Zipcode:{user.address.zipcod}</li>
        {/* <li className="list-group-item">Latitude:{user.geo.lat}</li> */}
        {/* <li className="list-group-item">Longitude:{user.geo.lng}</li> */}
        <li className="list-group-item">Phone:{user.phone}</li>
        <li className="list-group-item">Website:{user.website}</li>
        <li className="list-group-item">Name:{user.company.name}</li>
        <li className="list-group-item">CatchPhrase:{user.company.catchPhrase}</li>
